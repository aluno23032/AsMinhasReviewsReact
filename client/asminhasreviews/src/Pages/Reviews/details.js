                            ...
                            return (
                                <tr style={{ borderBottom: "1px solid #dee2e6", verticalAlign: "middle" }}>
                                    ...
                                    <td style={{ padding: "5px", width: "90%" }}>
                                        <div style={{ float: "left", width: "100%", textAlign: "left" }}><a style={{ textDecoration: "none" }} href={"../../Jogos/Details/" + val.Jogo}><h3 style={{ marginBottom: "0px" }} className="conteudoReview">{val.JogoNome}</h3></a></div>
                                        ...
                                        <div style={{ float: "left", width: "90%", textAlign: "left" }}>{val.Conteudo}</div>
